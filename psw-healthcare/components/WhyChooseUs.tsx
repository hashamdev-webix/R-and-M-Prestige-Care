...
export function WhyChooseUs() {
  const reasons = [
    ...
    },
    {
      ...
      description:
        "R&M Prestige Care works with certified Healthcare Aides, experienced caregivers, support workers, and compassionate care professionals who understand the importance of dependable care.",
    },
    {
      icon: Calendar,
    ...
    },
    {
      ...
      description:
        "R&M Prestige Care proudly supports Calgary families, seniors, private clients, care homes, and healthcare facilities across nearby areas.",
    },
  ];
  ...
  return (
    <section className="py-16 md:py-20 bg-white" aria-label="Why choose us">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          title="Why Families and Facilities Choose R&M Prestige Care"
          subtitle={
            <p className="mx-auto">
              ...
              R&M Prestige Care is built to support both with reliable service,
              flexible scheduling, and professional care standards.
            </p>
          }
          centered
          className="mb-12"
